...
} from "./chunk-X5ZQQ74D.js";
import {
  List_default
} from "./chunk-42RFOXKM.js";
import {
  GlobalStyles_default
} from "./chunk-5UZLT3LS.js";
import {
  FocusTrap,
  Modal_default,
  useModal
} from "./chunk-DPGIXLRN.js";
import {
  Portal
} from "./chunk-WWEVYAOC.js";
import {
  isFilled
...
var MenuList = React73.forwardRef(function MenuList2(props, ref) {
  const {
    // private
  ...
  const textCriteriaRef = React73.useRef({
    keys: [],
    repeating: true,
  ...
  React73.Children.forEach(children, (child, index2) => {
  ...
  const items = React73.Children.map(children, (child, index2) => {
    if (index2 === activeItemIndex) {
      ...
      return React73.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var Popover = React74.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OP4Y2NQP.js.map
