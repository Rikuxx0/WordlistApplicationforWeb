...
} from "./chunk-PRO2X4EV.js";
import "./chunk-OP4Y2NQP.js";
...
import {
  FormControl_default
} from "./chunk-UPJZWG56.js";
import "./chunk-AKKANAVW.js";
import {
  Stack_default,
  stackClasses_default
} from "./chunk-LEL7UBHC.js";
...
function DemoItem(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Stack_default, {
    ...
    spacing,
    sx,
    children: [label && (0, import_jsx_runtime8.jsx)(Typography_default, {
      variant: "body2",
      children: label
    }), children]
  });
...
var isDemoItem = (child) => {
  if (React8.isValidElement(child) && typeof child.type !== "string") {
...
function DemoContainer(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(Stack_default, {
    ...
    children: React8.Children.map(children, (child) => {
      if (React8.isValidElement(child) && isDemoItem(child)) {
